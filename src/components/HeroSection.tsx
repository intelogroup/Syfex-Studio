...
export const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-start justify-center p-4 relative">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-[100] pt-48">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, ease: "easeOut" }}
          className="floating space-y-12 md:space-y-16"
        >
          <motion.h1 
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto -mt-12"
          >
      ...
      {/* Simplified background particles with lower z-index */}
